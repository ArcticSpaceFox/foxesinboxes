          ...
          <section id="introduction">
            <div className="max-w-5xl mx-auto flex items-center min-h-3/4-screen px-2 py-4 sm:px-6 lg:px-8">
              ...
              <div className="mt-8 text-center">
                ...
                <h1 className="hidden sm:block mb-6 text-4xl lg:text-6xl font-extrabold text-gray-800 dark:text-gray-200">
                  What is this? I have questions!
                </h1>
                <h1 className="block sm:hidden mb-6 text-4xl font-extrabold text-gray-800 dark:text-gray-200">
                  Why am I here?
                </h1>
                <p className="text-xl text-gray-600 dark:text-gray-400 text-justify mx-6 md:mx-4 my-2">
                ...
                <div className="flex flex-wrap justify-evenly items-center mx-2 my-12">
                  <ul className="text-left text-xl sm:text-2xl tracking-wide font-semibold text-gray-600 dark:text-gray-400">
                    <li>
                      <span className="text-indigo-600 dark:text-indigo-400 font-black">?</span> what
                      exactly we collect
                    </li>
                    <li>
                      <span className="text-indigo-600 dark:text-indigo-400 font-black">?</span> what
                    ...
                    <li>
                      <span className="text-indigo-600 dark:text-indigo-400 font-black">?</span> why
                      we do what we do
                    </li>
                  </ul>
                  <img
          ...
          <section id="cookies">
            <div className="max-w-5xl mx-auto px-6 py-4 lg:px-8">
              <div className="border-l-2 border-indigo-600 pl-4">
                ...
                <h1 className="block mb-2 text-4xl lg:text-5xl font-extrabold text-gray-800 dark:text-gray-200">
                  For cookies{' '}
            ...
            <div className="max-w-5xl mx-auto px-2 py-4 sm:px-6 lg:px-8">
              <div className="text-xl text-gray-600 dark:text-gray-400 text-justify mx-6 md:mx-4 my-2">
                We use cookies for{' '}
                ...
                <span className="font-bold text-indigo-600 dark:text-indigo-400">authenticity</span>,{' '}
                <span className="font-bold text-indigo-600 dark:text-indigo-400">
                  confidentiality
                </span>{' '}
                and <span className="font-bold text-indigo-600 dark:text-indigo-400">integrity</span>
                .
              </div>

              <h3 className="uppercase font-bold text-xl ml-2 sm:ml-0 mt-6 dark:text-white">
                <span className="font-bold text-indigo-600 dark:text-indigo-400">#</span> integrity
              </h3>
              <div className="text-xl text-gray-600 dark:text-gray-400 text-justify mx-6 md:mx-4 my-2">
              ...
              <div className="max-w-lg mx-auto my-8 border border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 flex items-center font-mono text-gray-700 dark:text-gray-300 rounded-md shadow-xl overflow-hidden text-md sm:text-xl">
                <span className="rounded-l px-4 py-2 border-r border-gray-300 dark:border-gray-700 whitespace-no-wrap">
                  <svg
                  ...
                  <span className="text-green-500 dark:text-green-400 font-extrabold">https</span>
                  ://
                </span>
              ...
              <h3 className="uppercase font-bold text-xl ml-2 sm:ml-0 mt-6 dark:text-white">
                <span className="font-bold text-indigo-600 dark:text-indigo-400">#</span> authenticity
              </h3>
              <div className="text-xl text-gray-600 dark:text-gray-400 text-justify mx-6 md:mx-4 my-2">
              ...
              <h3 className="uppercase font-bold text-xl ml-2 sm:ml-0 mt-6 dark:text-white">
                <span className="font-bold text-indigo-600 dark:text-indigo-400">?</span> So what
