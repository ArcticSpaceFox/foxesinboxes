    ...
    >
      <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
          <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            <div className="md:flex md:items-start md:flex-col">
              ...
              <div className="mt-3 text-center sm:mt-0 sm:ml-4">
                <h3
                  className="text-2xl lg:text-4xl leading-6 tracking-wide font-medium text-gray-900"
                  id="modal-title"
                >
                  Foxes love cookies!
                </h3>
                <div className="mt-4">
                  ...
                  <p className="mt-2 text-md text-justify text-gray-500">
          ...
          <div className="bg-gray-100 border-t border-gray-400 border-opacity-40 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse sm:justify-center">
            <button
              type="button"
              className="mt-3 w-full inline-flex justify-center rounded-md cursor-pointer border shadow-sm px-4 py-2 bg-green-500 text-base text-white font-bold hover:bg-green-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm"
            ...
            >
              <div
                className="w-full inline-flex justify-center rounded-md cursor-pointer border border-transparent shadow-sm px-4 py-2 mt-2 sm:mt-0 border-gray-400 bg-gray-300 text-base font-medium text-gray-800 hover:text-gray-200 hover:bg-red-300 hover:border-red-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 sm:ml-3 sm:w-auto sm:text-sm"
              >
                No cookies pls
              </div>
            </Link>
